...
export class LdrPart {
  ...
  constructor(id: string, name: string, colorVertexMap: Map<number, Vector3[]>, colorIndexMap: Map<number, number[]>, lineColorMap: Map<number, Vector3[]>, references: PartReference[]) {
    this.id = id;
    this.name = name;
